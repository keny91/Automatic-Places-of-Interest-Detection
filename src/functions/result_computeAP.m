function [ valoration , unused_cores, pairing_matrix,n_asignated] = result_computeAP( monuments_XY , cores_XY, threshold, suboptimal_threshold, penalty )
...
valoration = (evaluation/n_monuments)*100;
